...
public class Executor implements IExecutor {
    ...
    @Override public void execute(Opcode opcode) {
        switch (opcode) {
            ...
            case Op6XNN o -> vm.setRegister(o.vx(), o.imm());
            case Op7XNN o -> vm.setRegister(o.vx(), (byte) (vm.getRegister(o.vx()) + o.imm()));
            case Op8XY0 o -> vm.setRegister(o.vx(), vm.getRegister(o.vy()));
            case Op8XY1 o -> vm.setRegister(o.vx(), (byte) (vm.getRegister(o.vx()) | vm.getRegister(o.vy())));
            case Op8XY2 o -> vm.setRegister(o.vx(), (byte) (vm.getRegister(o.vx()) & vm.getRegister(o.vy())));
            case Op8XY3 o -> vm.setRegister(o.vx(), (byte) (vm.getRegister(o.vx()) ^ vm.getRegister(o.vy())));
            case Op8XY4 o -> {
            ...
            case OpANNN o -> vm.setI(o.address());
            case OpBNNN o -> vm.setPC(
                (short) (((vm.getRegister(0) & 0xFF) + o.address())) & 0xFFFF);
            case OpCXNN o -> vm.setRegister(o.vx(), (byte) (o.imm() & hal.getRand()));
            case OpDXYN o -> {
            ...
            case OpEXA1 o -> {
                Optional<Byte> key = hal.getKey();
                if (key.isEmpty() || key.get() != vm.getRegister(o.vx())) {
                    vm.setPC(vm.getPC() + 2);
                }
            }
            case OpFX07 o -> vm.setRegister(o.vx(), vm.getDelayTimer());
            case OpFX0A o -> {
                Optional<Byte> key = hal.getKey();
                if (key.isEmpty()) {
                    vm.setPC(vm.getPC() - 2);
            ...
            case OpFX15 o -> vm.setDelayTimer(vm.getRegister(o.vx()));
            case OpFX18 o -> vm.setSoundTimer(vm.getRegister(o.vx()));
            case OpFX1E o -> vm.setI(
                (short) (0xFFFF & vm.getI() + (0xFF & vm.getRegister(o.vx()))));
            case OpFX29 o -> vm.setI(characterAddressLocator
                .getCharacterAddress(vm.getRegister(o.vx())));
            case OpFX33 o -> {
                int I = vm.getI();
